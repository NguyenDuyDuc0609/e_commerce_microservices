...
{
    public class AddProductHandler(IUnitOfWork unitOfWork) : IRequestHandler<AddProductCommand, CommandDto>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork ?? throw new ArgumentNullException(nameof(unitOfWork));

        public Task<CommandDto> Handle(AddProductCommand request, CancellationToken cancellationToken)
        {
